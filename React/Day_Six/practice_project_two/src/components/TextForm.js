...
export default function TextForm(props) {
    ...
    const handleCopy = () => {
        ...
        document.title = 'TextUtils - Text Copied';
    ...
    return (
        <>
            <div className="container" style={{ color: 'white' }}>
                ...
                <div className="mb-3">
                    <textarea className="form-control" style={{ backgroundColor: 'grey' }} value={text} onChange={handleOnChange} id="myBox" rows="8"></textarea>
                </div>
