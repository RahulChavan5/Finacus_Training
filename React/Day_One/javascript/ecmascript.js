...
register('rahul','rahul123','photo.png')
...
// ---------------------------------------------------------------------------------------------------------------
// find method  -(array)
// const peoples = [{named:'rahul'},{named:'rutik'}]

// const people= peoples.find((people)=>{
//     return people.named==='rahul'
// })
